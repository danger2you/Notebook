# IDEA破解
## 1. 下载破解文件
附件：jetbrains-agent.jar

## 2. 文件复制
* 将文件复制到文件目录   位置：IDEA安装目录/bin

## 3. 修改文件
* 文件位置： IDEA安装目录/bin    idea.exe.vmoptions 和 idea64.exe.vmoptions
* 末行添加内容：
-javaagent: 后面是文件的路径，
```
-javaagent:C:\Program Files\JetBrains\PhpStorm 2018.3.4\lib\jetbrains-agent.jar
```

## 4. 输入激活码
* 重启IDEA
* 在图片位置输入激活码
![active_code](_v_images/20191108115824605_1977.png)
* 激活码
```
